...
//    public volatile InventoryText text = new InventoryText("TITLE",
...
//            Arrays.asList("This text is supposed to be long enough not to fit into description frame. Unfortunately, it does now, so i should type more for this be bigger".split(" ")),
...
//    );
    ...
    static char up = (char) 9195;
    static char down = (char) 9196;
