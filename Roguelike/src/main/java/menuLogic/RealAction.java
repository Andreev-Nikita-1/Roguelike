...
class RealAction extends MenuAction {
    ...
    static RealAction loadGameAction = new RealAction("load game", Controller::drawFileDialog);
    ...
    static RealAction back = new RealAction("back", () -> Controller.drawMenu(Controller.lastMenu));
